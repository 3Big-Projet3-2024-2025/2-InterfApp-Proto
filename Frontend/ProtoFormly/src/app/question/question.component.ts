...
export class QuestionComponent {
  ...
  questionTypes: string[] = ["Short Answer","Open Answer","Checkbox","Multiple choice", "Date question","Date and time question" , "datetime" ,"Email question" ,"Ask for a file " ,"Ask for a image" ,"Number question" ,"Range question" ,"Month question" , "Time question" , "Ask for a phone number" ,"Ask for a url","Week question"  ];
  choices: string[] = ["",""];
